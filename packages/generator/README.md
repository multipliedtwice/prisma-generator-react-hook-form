...
[![Coverage](https://img.shields.io/codecov/c/github/multipliedtwice/prisma-generator-react-hook-form/main.svg)](https://codecov.io/gh/multipliedtwice/prisma-generator-react-hook-form)
...
```bash
 npm install prisma-generator-react-hook-form
```

Using yarn:

```bash
 yarn add prisma-generator-react-hook-form
```
...
```prisma
generator express {
  provider = "prisma-generator-react-hook-form"
}
```
